        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/runnel.Tunnel/TunnelMessage",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("runnel.Tunnel", "TunnelMessage"));
...
pub mod tunnel_server {
    ...
    pub trait Tunnel: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the TunnelMessage method.
        type TunnelMessageStream: tonic::codegen::tokio_stream::Stream<
        ...
        async fn tunnel_message(
            ...
            tonic::Response<Self::TunnelMessageStream>,
            tonic::Status,
        >;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/runnel.Tunnel/TunnelMessage" => {
                    ...
                    struct TunnelMessageSvc<T: Tunnel>(pub Arc<T>);
                    impl<T: Tunnel> tonic::server::StreamingService<super::TunnelRequest>
                    for TunnelMessageSvc<T> {
                        type Response = super::TunnelResponse;
                        type ResponseStream = T::TunnelMessageStream;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Tunnel>::tunnel_message(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = TunnelMessageSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "runnel.Tunnel";
